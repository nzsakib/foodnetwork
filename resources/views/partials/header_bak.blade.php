<header id="header" class="header-scroll top-header headrom">
    ...
    <nav class="navbar navbar-dark">
        <div class="container">
            ...
            <a class="navbar-brand" href="{{ url('/') }}"> RestaurantPicker </a>
...
<li class="nav-item"> <a class="nav-link active" href="{{ url('/') }}">Home <span class="sr-only">(current)</span></a> </li>
        ...
        @if (Auth::guest())
            <li class="nav-item">
                <a href="{{ url('auth/login') }}" class="nav-link">Sign in</a>
            </li>
            <li class="nav-item">
        ...
        @endif
                    ...
                    <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">Food</a>
                        <div class="dropdown-menu"> 
                        <a class="dropdown-item" href="food_results.html">Food results</a> 
